...
static cl_int queue_sonoa_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
  cl_kernel *kernel;
  unsigned int num;
  cl_ulong le_target;
...
#undef A_DARK
  ...
  { "sonoa", ALGO_SONOA, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 3, 8 * 16 * 4194304, 0, sonoa_regenhash, NULL, queue_sonoa_kernel, gen_hash, append_x11_compiler_options },
